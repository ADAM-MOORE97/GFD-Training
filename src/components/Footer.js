...
export default function () {
  return (
    <footer class="text-center lg:text-left bg-blue-900 text-gray-300">
  <div class="flex justify-center items-center lg:justify-between p-6 border-b-4 border-yellow-300">
    ...
    <div class="flex justify-center">
      ...
      <a href="#!" class="mr-6 text-blue-600">
