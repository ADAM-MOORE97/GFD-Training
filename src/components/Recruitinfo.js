...
export default function Recruitinfo() {
  ...
  return (
    <div className='border-2 border-solid bg-slate-50 mx-auto mt-6 mb-6 p-10 md:w-3/4'>
      <h3 className='mt-6 mb-6 text-xl md:text-2xl lg:text-3xl xl:text-4xl'>Recruit Class 2202</h3>
      <Swiper
        className='h-96'
      ...
      <div className='mx-auto bg-red-600 text-white mt-6 p-6'>
        <h4 className='underline'>Class Roster</h4>
        {roster.map(names => <em className='mr-3 ml-3'>{names}</em>)}
        <div className='mt-6'>
          <em> "Insert recruit class motivational statement here" -Class 2202</em>
        </div>
      </div>
  <div className='mt-6 mx-auto bg-blue-800 rounded-xl w-1/4'>
<p>
